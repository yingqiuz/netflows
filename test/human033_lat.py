...
human033_adj = human033['human033_adj_lat'][0]
...
with open('G_human033_lat.pickle', 'wb') as f:
    pickle.dump({'G_human033_lat': G_human033}, f, protocol=pickle.HIGHEST_PROTOCOL)
