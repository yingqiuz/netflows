...
def create_distribution_nodal(model, num_perm_models):
    ...
    """
    with open('analysis/' + model + '_dfs2.pickle', 'rb') as f:
        dfs = pickle.load(f)
    ...
    for col in columns:
        ...
        for k in range(num_perm_models):
            with open('analysis/' + model + '_perm' + str(k) + '_dfs2.pickle', 'rb') as f:
...
if __name__ == "__main__":
    ...
    with open('analysis/stats/' + model + '_dfs2_p.pickle', 'wb') as f:
